...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { mrp: @order_detail.mrp, quantity: @order_detail.quantity, total: @order_detail.total }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { mrp: @order_detail.mrp, quantity: @order_detail.quantity, total: @order_detail.total }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
